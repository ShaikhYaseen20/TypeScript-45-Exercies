/*Assignment Number 44.  Sandwiches: Write a function that accepts a array of items a person wants on a sandwich. The function
...
let collection1 = mySandwiches("Chiken","Ham","Cheeze"); //can add as many you wish
